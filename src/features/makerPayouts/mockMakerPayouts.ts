...
export const detailedTransactions = [
  { id: 'txn-d001', date: '2024-12-20', type: 'Job payout', reference: 'job-001', amount: 125.00, status: 'Available', jobTitle: 'Custom Phone Case - iPhone 15', jobId: 'job-001', payoutDate: '2024-12-27' },
  { id: 'txn-d002', date: '2024-12-20', type: 'Bonus', reference: 'job-001', amount: 15.00, status: 'Available', jobTitle: 'Custom Phone Case - iPhone 15', jobId: 'job-001', payoutDate: '2024-12-27' },
  { id: 'txn-d003', date: '2024-12-19', type: 'Job payout', reference: 'job-003', amount: 89.50, status: 'Pending', jobTitle: 'Automotive Part - Brake Mount', jobId: 'job-003', payoutDate: null },
  { id: 'txn-d004', date: '2024-12-19', type: 'Adjustment', reference: 'job-003', amount: -5.00, status: 'Pending', jobTitle: 'Automotive Part - Brake Mount', jobId: 'job-003', payoutDate: null },
  { id: 'txn-d005', date: '2024-12-18', type: 'Job payout', reference: 'job-002', amount: 75.25, status: 'Paid', jobTitle: 'Miniature Dragon Figure', jobId: 'job-002', payoutDate: '2024-12-14' },
  { id: 'txn-d006', date: '2024-12-18', type: 'Bonus', reference: 'job-002', amount: 10.00, status: 'Paid', jobTitle: 'Miniature Dragon Figure', jobId: 'job-002', payoutDate: '2024-12-14' },
  { id: 'txn-d007', date: '2024-12-17', type: 'Job payout', reference: 'job-004', amount: 45.00, status: 'Available', jobTitle: 'Jewelry Display Stand', jobId: 'job-004', payoutDate: '2024-12-27' },
  { id: 'txn-d008', date: '2024-12-17', type: 'Bonus', reference: 'job-004', amount: 5.00, status: 'Available', jobTitle: 'Jewelry Display Stand', jobId: 'job-004', payoutDate: '2024-12-27' },
  { id: 'txn-d009', date: '2024-12-16', type: 'Job payout', reference: 'job-005', amount: 120.00, status: 'Paid', jobTitle: 'Custom Keychain Set', jobId: 'job-005', payoutDate: '2024-12-14' },
  { id: 'txn-d010', date: '2024-12-16', type: 'Bonus', reference: 'job-005', amount: 20.00, status: 'Paid', jobTitle: 'Custom Keychain Set', jobId: 'job-005', payoutDate: '2024-12-14' },
  { id: 'txn-d011', date: '2024-12-16', type: 'Adjustment', reference: 'job-005', amount: -10.00, status: 'Paid', jobTitle: 'Custom Keychain Set', jobId: 'job-005', payoutDate: '2024-12-14' },
  { id: 'txn-d012', date: '2024-12-15', type: 'Job payout', reference: 'job-006', amount: 200.00, status: 'Available', jobTitle: 'Prototype Widget', jobId: 'job-006', payoutDate: '2024-12-27' },
  { id: 'txn-d013', date: '2024-12-15', type: 'Bonus', reference: 'job-006', amount: 25.00, status: 'Available', jobTitle: 'Prototype Widget', jobId: 'job-006', payoutDate: '2024-12-27' },
  { id: 'txn-d014', date: '2024-12-14', type: 'Payout transfer', reference: 'payout-001', amount: -890.25, status: 'Completed', jobTitle: 'Payout Transfer', jobId: 'payout-001', payoutDate: '2024-12-14' },
  { id: 'txn-d015', date: '2024-12-13', type: 'Job payout', reference: 'job-007', amount: 180.00, status: 'Pending', jobTitle: 'Medical Device Component', jobId: 'job-007', payoutDate: null },
  { id: 'txn-d016', date: '2024-12-13', type: 'Adjustment', reference: 'job-007', amount: -15.00, status: 'Pending', jobTitle: 'Medical Device Component', jobId: 'job-007', payoutDate: null },
  { id: 'txn-d017', date: '2024-12-12', type: 'Job payout', reference: 'job-008', amount: 95.00, status: 'Paid', jobTitle: 'Architecture Model Part', jobId: 'job-008', payoutDate: '2024-12-07' },
  { id: 'txn-d018', date: '2024-12-12', type: 'Bonus', reference: 'job-008', amount: 12.00, status: 'Paid', jobTitle: 'Architecture Model Part', jobId: 'job-008', payoutDate: '2024-12-07' },
  { id: 'txn-d019', date: '2024-12-11', type: 'Job payout', reference: 'job-009', amount: 65.00, status: 'Available', jobTitle: 'Gaming Accessory', jobId: 'job-009', payoutDate: '2024-12-27' },
  { id: 'txn-d020', date: '2024-12-11', type: 'Bonus', reference: 'job-009', amount: 8.00, status: 'Available', jobTitle: 'Gaming Accessory', jobId: 'job-009', payoutDate: '2024-12-27' },
  { id: 'txn-d021', date: '2024-12-11', type: 'Adjustment', reference: 'job-009', amount: -2.00, status: 'Available', jobTitle: 'Gaming Accessory', jobId: 'job-009', payoutDate: '2024-12-27' },
  { id: 'txn-d022', date: '2024-12-10', type: 'Job payout', reference: 'job-010', amount: 150.00, status: 'Paid', jobTitle: 'Industrial Fixture', jobId: 'job-010', payoutDate: '2024-12-07' },
  { id: 'txn-d023', date: '2024-12-09', type: 'Job payout', reference: 'job-011', amount: 300.00, status: 'Available', jobTitle: 'Art Installation Piece', jobId: 'job-011', payoutDate: '2024-12-27' },
  { id: 'txn-d024', date: '2024-12-09', type: 'Bonus', reference: 'job-011', amount: 40.00, status: 'Available', jobTitle: 'Art Installation Piece', jobId: 'job-011', payoutDate: '2024-12-27' },
  { id: 'txn-d025', date: '2024-12-08', type: 'Job payout', reference: 'job-012', amount: 55.00, status: 'Pending', jobTitle: 'Kitchen Utensil Holder', jobId: 'job-012', payoutDate: null },
  { id: 'txn-d026', date: '2024-12-08', type: 'Bonus', reference: 'job-012', amount: 5.00, status: 'Pending', jobTitle: 'Kitchen Utensil Holder', jobId: 'job-012', payoutDate: null },
  { id: 'txn-d027', date: '2024-12-07', type: 'Payout transfer', reference: 'payout-002', amount: -1250.75, status: 'Completed', jobTitle: 'Payout Transfer', jobId: 'payout-002', payoutDate: '2024-12-07' },
  { id: 'txn-d028', date: '2024-12-06', type: 'Job payout', reference: 'job-013', amount: 80.00, status: 'Paid', jobTitle: 'Drone Part - Propeller Guard', jobId: 'job-013', payoutDate: '2024-12-07' },
  { id: 'txn-d029', date: '2024-12-06', type: 'Bonus', reference: 'job-013', amount: 10.00, status: 'Paid', jobTitle: 'Drone Part - Propeller Guard', jobId: 'job-013', payoutDate: '2024-12-07' },
  { id: 'txn-d030', date: '2024-12-06', type: 'Adjustment', reference: 'job-013', amount: -3.00, status: 'Paid', jobTitle: 'Drone Part - Propeller Guard', jobId: 'job-013', payoutDate: '2024-12-07' },
];
